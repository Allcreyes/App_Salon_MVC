...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido .= "<p>Presiona aquí para confirmar:<strong> <a href='" . $_ENV['SERVER_HOST'] . "confirmar-cuenta?token=" . $this->token . "'>Confirmar Cuenta</a></strong></p><br>";
    ...
    public function enviarInstrucciones()
    {
        ...
        // Set HTML
        $contenido = "<html>";
        $contenido .= "<p>Estimado(a)<strong> " . $this->nombre . " " . $this->aPaterno . "</strong>, has solicitado reestablecer tu contraseña, sigue el siguiente enlace para hacerlo.</p><br>";
        $contenido .= "<p>Presiona aquí para reestablecer:<strong> <a href='" . $_ENV['SERVER_HOST'] . "recuperar?token=" . $this->token . "'>Reestablecer Contraseña</a></strong></p><br>";
